...
if [ $count -eq 0 ]; then
    ...
    /usr/local/vitess/bin/vtctlclient --server $localhost:15999 TabletExternallyReparented zone1-410


else
    /usr/local/vitess/bin/vtctlclient --server $localhost:15999 TabletExternallyReparented zone1-409
